...
public final class Keys {
    ...
    public static final ConfigKey<String> RABBITMQ_HOSTNAME = new StringConfigKey(
            "rabbitMq.hostname",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<String> RABBITMQ_USERNAME = new StringConfigKey(
            "rabbitMq.username",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<String> RABBITMQ_PASSWORD = new StringConfigKey(
            "rabbitMq.password",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<String> RABBITMQ_VIRTUAL_HOST = new StringConfigKey(
            "rabbitMq.virtualHost",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<Integer> RABBITMQ_PORT = new IntegerConfigKey(
            "rabbitMq.port",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<String> RABBITMQ_QUEUE = new StringConfigKey(
            "rabbitMq.queue",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<String> RABBITMQ_EXCHANGE = new StringConfigKey(
            "rabbitMq.exchange",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<String> RABBITMQ_ROUTING_KEY = new StringConfigKey(
            "rabbitMq.routingKey",
            List.of(KeyType.CONFIG));

    public static final ConfigKey<Boolean> RABBITMQ_DURABLE = new BooleanConfigKey(
            "rabbitMq.durable",
            List.of(KeyType.CONFIG));
