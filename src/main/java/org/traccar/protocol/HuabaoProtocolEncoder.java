            ...
            switch (command.getType()) {
                case Command.TYPE_ENGINE_STOP:
                    if (alternative) {
                        ...
                        return HuabaoBinaryProtocolDecoder.formatMessage(
                                HuabaoBinaryProtocolDecoder.MSG_OIL_CONTROL, id, false, data);
                    } else {
                        data.writeByte(0xf0);
                        return HuabaoBinaryProtocolDecoder.formatMessage(
                                HuabaoBinaryProtocolDecoder.MSG_TERMINAL_CONTROL, id, false, data);
                    }
