...
public class Position extends Message {
    ...
    public static final String KEY_DRIVER_LICENCE = "driverLicense";
    ...
    public static final String KEY_VEHICLE_REGISTRATION = "carReg";
    public static final String KEY_LATITUTE_DIRECTION = "latDi";
    public static final String KEY_LONGITUTE_DIRECTION = "lonDir";
    public static final String KEY_SIGNAL_WIRE = "signalWireConnected";
    public static final String KEY_POWER_WIRE = "powerWireConnected";
    public static final String KEY_ANTENNA_CONNECTED = "antennaConnected";
    ...
    public static final String ALARM_LIMP_MODE = "limpMode";
    public static final String ALARM_SPEED_SENSOR_DISCONNECTED = "speedSensorDisconnected";
